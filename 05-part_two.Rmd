...
In `testthat`, tests are called **expectations**. These spell out the expected behaviour of the function or unit of code. `testthat` provides many functions to define expectations - see details [here](http://r-pkgs.had.co.nz/tests.html). It is good practice to save tests relating to the [different code files](#code_structure) in different test files, all saved within a dedicated testing directory. Below is an example of testing a simple function.
